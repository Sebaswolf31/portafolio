        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8">
            ...
            <div className="flex space-x-6">
              <a href="#about" className="text-zinc-400 hover:text-cyan-400 transition-colors text-sm">{t('nav.about')}</a>
              <a href="#skills" className="text-zinc-400 hover:text-cyan-400 transition-colors text-sm">{t('nav.skills')}</a>
              <a href="#projects" className="text-zinc-400 hover:text-cyan-400 transition-colors text-sm">{t('nav.projects')}</a>
              <a href="#contact" className="text-zinc-400 hover:text-cyan-400 transition-colors text-sm">{t('nav.contact')}</a>
            </div>
