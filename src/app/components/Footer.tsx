    ...
    <footer className="py-8 bg-zinc-950 relative overflow-hidden border-t border-zinc-900">
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8">
            ...
            <div className="flex space-x-6">
              <a href="#about" className="text-zinc-400 hover:text-cyan-400 transition-colors text-sm">About</a>
              <a href="#skills" className="text-zinc-400 hover:text-cyan-400 transition-colors text-sm">Skills</a>
              <a href="#projects" className="text-zinc-400 hover:text-cyan-400 transition-colors text-sm">Projects</a>
              <a href="#contact" className="text-zinc-400 hover:text-cyan-400 transition-colors text-sm">Contact</a>
            </div>
        ...
        <div className="mt-8 pt-6 border-t border-zinc-900 flex flex-col md:flex-row justify-between items-center">
          <p className="text-zinc-600 text-sm">&copy; {currentYear} Markel Ramiro. All rights reserved.</p>
          
          <div className="mt-4 md:mt-0 text-zinc-600 text-xs">
            Built with <span className="text-cyan-500">♥</span> using Next.js and Tailwind CSS
          </div>
        </div>
      </div>
    </footer>
